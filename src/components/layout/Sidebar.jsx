  ...
  return (
    <>
      ...
      <aside className={[styles.sidebar, open ? styles.open : ''].join(' ')}>
        ...
        {/* Logo — VLC image replacing text */}
        <div className={styles.logo}>
          <img
            src="/vlc-logo-wide.jpg"
        ...
        <nav className={styles.nav}>
          <div className={styles.section}>
            ...
            <NavItem to="/dashboard/schedule"    icon={<CalIcon />}   label="Schedule"    onClick={onClose} />
            <NavItem to="/dashboard/release"     icon={<NotesIcon />} label="Release notes" onClick={onClose} />
          </div>
